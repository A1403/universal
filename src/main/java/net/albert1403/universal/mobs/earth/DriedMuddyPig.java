package net.albert1403.universal.mobs.earth;
...
public class DriedMuddyPig extends Animal implements ItemSteerable, Saddleable {
    ...
    public DriedMuddyPig(EntityType<? extends Animal> entityType, Level level) {
    ...
    @Override
    public DriedMuddyPig getBreedOffspring(ServerLevel p_149001_, AgeableMob p_149002_) {
        return Entities.DRIED_MUDDY_PIG.get().create(level);
    }
...
//https://www.youtube.com/watch?v=iMJ1kWNWQBQ 14:50!!

//-Modell,Textur,Spawning,Drops!!